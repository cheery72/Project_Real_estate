...
export default new Vuex.Store({
    ...
    actions: {
        ...
        getSchoolList({ commit }, dongName) {
            const params = { dong: dongName };
            http.get(`/school/schoolinfo`, { params })
                .then((response) => {
    ...
    modules: { memberStore, boardStore, commentStore },
    plugins: [
