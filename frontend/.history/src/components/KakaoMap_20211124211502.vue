        ...
        markerPositions.forEach((position) =>
            ...
            kakao.maps.event.addListener(marker, 'click',() => {
             ...
             circle = new kakao.maps.Circle({
                 ...
                 // center : marker.getPosition(),//위치를 가져옴
                ...
                //          console.log("cctv",result);
                //      }
                //   };

                // places.keywordSearch('cctv', callback, {radius : 2000, location: marker.getPosition()});
      
             // 원(Circle)의 옵션으로 넣어준 반지름
            var radius = 3000;

            var markers=[];
            markers[0]=this.subwaymarkers;
            markers[1]=this.cctvmarkers;

            console.log("gngn",markers[0]);

            // 마커들이 담긴 배열
            //   markers.forEach((m)=> {
                var c1 = marker.getPosition();
                var c2 = markers[0].getPosition();
