...
<div class="container">
    <div class="row py-5 mt-4 align-items-center">
        ...
        <div class="col-md-7 col-lg-6 ml-auto">
          ...
          label="아이디:"
          label-for="userid"
          description="" class="input-group-prepend">
            ...
            required
            placeholder="아이디 입력"
            @keyup="idCheck" class="form-control bg-white border-left-0 border-md">
                    </div>
 ...
 <!--비밀번호-->
          ...
          description="" class="input-group-prepend">
            ...
            type="text"
            required
            placeholder="비밀번호 입력" class="form-control bg-white border-left-0 border-md">
                    </div>
                    <div>{{ validcheck }}</div>

                     <!--비밀번호 확인-->
                     <div class="input-group col-lg-12 mb-4">
                        <div id="userpwd-group" label="비밀번호 확인:" description="" class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                                <i class="fa fa-envelope text-muted"></i>
                            </span>
                        </div>
                        <input id="user_pass_ck"
            type="password"
            required
            @keyup="checkPw"
            v-model="user.userpwd_ck"
            label-for="userpwd_ck"
            placeholder="비밀번호 확인" class="form-control bg-white border-left-0 border-md">
                    </div>
                      <div>{{ pwcheck }}</div>
          ...
          description="" class="input-group-prepend">
            ...
            type="text"
            required
            placeholder="이름 입력" class="form-control bg-white border-left-0 border-md">
                    </div>
          ...
          description="" class="input-group-prepend">
            ...
            type="text"
            required
            placeholder="이메일 입력" class="form-control bg-white border-left-0 border-md">
                    </div>
                    ...
                    <div class="form-group col-lg-12 mx-auto mb-0">
                      <b-button type="submit" variant="primary" class="btn btn-primary btn-block py-2"
          >회원가입
        </b-button>
        <b-button type="reset"  class="btn btn-primary btn-block py-2">초기화</b-button>
